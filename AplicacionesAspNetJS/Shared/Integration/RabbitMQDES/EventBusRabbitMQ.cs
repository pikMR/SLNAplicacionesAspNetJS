using AplicacionesAspNetJS.Shared.Integration.Bus;
...
namespace AplicacionesAspNetJS.Shared.Integration.RabbitMQDES
{
    public class EventBusRabbitMQ : IEventBus, IDisposable
    {
        private readonly string _brokerName = "fruit_event_bus";
